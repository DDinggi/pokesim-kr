...
- 내 기록 — 누적 운과 힛카드 기록을 로그인 없이 사용하고, 사용자가 선택하면 Google 계정에 보관해 다른 기기에서 이어보기.
...
> 노출 세트의 단일 출처는 [data/sets-index.json](data/sets-index.json)의 `active_sets`. 신규 세트는 데이터 검증을 마치는 대로 추가.

### MEGA (11)

- MEGA 확장팩 「30th CELEBRATION」
- 포켓몬 카드 게임 MEGA 「잉어킹 스페셜 세트」 — 7종 확장팩 각 4팩
