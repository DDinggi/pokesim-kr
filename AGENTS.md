...
- 2026-06-27 — **썬&문 SM10 계열 3종 추가.** 스카이레전드·GG엔드·더블블레이즈를 한국 공식 상품 구성으로 등록하고, 일본판 전체 목록 대조로 누락 HR/UR 23장을 한국 정식명·일본 이미지·시세와 함께 보강. 세트별 고레어 풀 비율, 운 분포, 256/512 이미지 파이프라인을 동기화.
