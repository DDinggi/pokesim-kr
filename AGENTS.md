...
- 다중 세트 (현재 **active 86종**, MEGA + SV + 소드실드 + 썬&문 라인업)
...
운영 중인 것:
  ...
  - active 86종 (MEGA + SV + 소드실드 + 썬&문 라인업, data/sets-index.json)
