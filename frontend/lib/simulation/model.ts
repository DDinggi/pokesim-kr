...
const SM6A_DRAGON_STORM: StandardSvSetRate = {
  ...SM_DARK_ORDER,
};

const SM5PLUS_ULTRA_FORCE: StandardSvSetRate = {
  ...SM_DARK_ORDER,
};
...
const SM6_FORBIDDEN_LIGHT: StandardSvSetRate = {
  ...SM8_BURST_IMPACT,
  rrBaseCount: 4,
  rrExtraRate: 1 / 3,
};
...
/**
 * 일반 100개 덱은 같은 확률로 뽑힌다(대표카드 = RR 80 + AR 14 + SR 4 + SAR 2).
 ...
 */
export const STARTER_NORMAL_POOL_SIZE = 100;
export const STARTER_NORMAL_RR_COUNT = 80;
